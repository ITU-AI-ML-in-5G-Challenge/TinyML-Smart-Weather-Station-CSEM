...
workspace = "/local/user/jrn/HTS-Audio-Transformer" # the folder of your code
dataset_path = "/local/user/jrn/data/ESC-50" # the dataset path
desed_folder = "/local/user/jrn/data/desed" # the desed file
...
resume_checkpoint = '/local/user/jrn/HTS-Audio-Transformer/results/HTSAT_ESC_exp=1_fold=1_acc=0.985.ckpt'
...
wa_folder = workspace + "/results/checkpoints/"
# weight average output filename
wa_model_path = workspace + "/results/HTSAT_AudioSet_Saved_x.ckpt"
